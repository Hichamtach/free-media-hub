...
* [Selfhosting Guide](/other/selfhosting) - Run FMHY Locally
* [Markdown Files](https://github.com/fmhy/FMHYedit/archive/refs/heads/main.zip) - Raw .zip Archive
* [Markdown Page](https://api.fmhy.net/single-page) (Mirrors: [2](https://api.fmhy.net/single-page) / [3](https://fmhyapi.wispy.qzz.io/single-page)) - Entire Markdown on Single Page
...
[FMHY.net](/other/backups) / [Reddit](/other/backups) / [GitHub](https://github.com/nbats/FMHY/wiki/Backups/) / [Rentry](https://rentry.co/FMHYbackups/)
