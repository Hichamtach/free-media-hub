...
- Added [Switch](/gaming-tools#switch-homebrew),
  [Wii U / Wii](/gaming-tools#wii-u-wii-homebrew),
  [3DS / DS](/gaming-tools#_3ds-ds-homebrew), and
  [PlayStation](/gaming-tools#playstation-homebrew) sections to
  Homebrew.
- Added [Virtual Reality](/gaming#virtual-reality)
  and [Game Save](/gaming-tools#game-saves) sections to Gaming.

- Added [Dev Communities](/developer-tools#dev-communities) and
  [Reverse Engineering](/developer-tools#reverse-engineering) sections
  to Dev Tools.

- Added [Linux Communities](/linux-macos#linux-communities)
  section to Linux.

- Added [Flights](/misc#flights) section to Travel.

- Organized the Maps section and added multiple
  [new subsections](/misc#maps) to it.

- Debloated [Indexes](/misc#indexes),
  [Multi-Tool](/misc#multi-tool-sites),
  [File Scanners](/privacy#file-scanners),
  [Archiving](/internet-tools#archiving), and
  [Sheet Music](/storage#music-sheet-collections) sections.

- Re-added our
  [Unsafe Sites Filter](https://github.com/WindowsAurora/FMHYFilterlist/). This
  can be added to uBlock to stop anything in
  [unsafe sites](/unsafe) from loading in your browser.
...
- Starred both squid.wtf and MP3 Daddy in
  [Audio Ripping](/audio#audio-ripping-sites). Deezer
  ripping sites both capable of getting FLAC files.

- Starred [Morphic](/ai#online-chatbots) in Online Chatbots.
  GPT-4o-powered search w/ no limits.

- Starred [ROM Heaven](/gaming#rom-sites) in ROM
  sites. Badass new ROM site with single-click DDL and a high-quality UI.

- Starred [Eaglercraft](/gaming-tools#minecraft-tools) in
  Minecraft as it's started getting updates again.

- Starred [CompactGUI](/file-tools#file-archivers) in File
  Archivers. Very [useful](https://ibb.co/xm23Xbh) archiver with a nice UI.

- Starred [Spicetify](/audio#spotify-adblockers) in
  Spotify Adblockers. This has adblock plugins that work just as well as SpotX.

- Starred [UI Revert Script](/social-media-tools#reddit-tools)
  in Reddit Tools. Restores Reddit's 2023 UI.

- Starred [Snaptick](/storage#to-do-apps) in Android To-Do Apps.
  Very feature-rich to-do app.

- Starred [PurpleAdblock](/social-media-tools#twitch-adblockers)
  in Twitch Adblockers. Got an update recently and seems to be working again.

- Starred [ImageGlass](/image-tools#image-viewers) in Image
  Viewers. Popular lightweight image viewer with a nice UI.

- Starred [Neal.fun](/storage#fun-indexes) in Fun Indexes. OG
  site with lots of fun games / experiments.

- Starred [Pi-hole](/privacy#dns-adblocking) in DNS
  Adblockers as their lists are more updated than NextDNS.

- Starred [ChatGPT](/ai#online-chatbots) in Online Chatbots as
