...
- Added [Stremio Tools](/video#stremio-tools) section
  to Streaming.

- Added [Video Generation](/ai#video-generation) section to AI.

- Added [Audio Transcription](/text-tools#audio-transcription)
  section to Text Tools.

- Added [System Audio](/system-tools#system-audio) and
  [USB / Bootloaders](/system-tools#usb-bootloaders) sections to
  System Tools.

- Added [Network Security](/privacy#network-security)
  section to Privacy.

- Added
  [Fanfiction / Stories](/reading#fanfiction-stories)
  section to Reading.

- Added [Audio Metadata](/audio#audio-metadata)
  section to Audio.

- Added [Wayland Compositors](/linux-macos#wayland-compositors)
  section to Linux.

- Added [LaTeX Tools](/storage#latex-tools) section to Math.

- Turned [Email Tools](/internet-tools#email-tools) into a main
  section with subsections.

- Split the Subtitle section into
  [Tools](/video#subtitles) and
  [Downloads](/video#download-subtitles).
...
- Cleaned up [Video Hosts](https://fmhy.pages.dev/video-tools#video-file-hosts),
  [Image Optimization](/image-tools#image-optimization), and
  [Icons / Avatars](/image-tools#icons-avatars) sections.
...
- Starred [Hidan](/file-tools#file-hosts) in File Hosts. Fast,
  unlimited size, no account required; publishes when they remove files.

- Starred [Catppuccin](/system-tools#custom-themes) in Custom
  Themes. High-quality pastel system app themes.

- Starred [Bio Link](/internet-tools#link-in-bio-sites) in Link
  in Bio Sites. Feature-rich, nice UI; stood out to us when going through the
  section.

- Starred [RetroAchievements](/gaming#emulators) in
...
- Starred [sdk.vercel](/ai#online-chatbots) in Online Chatbots.
  Chatbot playground with unlimited GPT-4o.

- Starred [FossifyOrg](/mobile#foss-apks) in FOSS
  APKs. Covers most basic apps, minimal UI.

- Starred
  [Universal Android Debloater](/mobile#optimization)
  in Android Optimization. Updated fork of the original UAD.

- Starred [Amarok](/mobile#android-privacy) in Android
  Privacy. Easily hide private files / apps on Android.

- Starred [Sideloadly](/mobile#ios-apps) in iOS Apps.
  Lightweight, simple setup, and auto-updates apps.

- Starred [EeveeSpotify](/mobile#ios-audio) in iOS
  Audio. Updated Spotify premium app now that Spotilife has stopped working.

- Starred [S0undTV](/mobile#smart-tv-firestick) in
  Firestick. Ad-free Twitch for Firestick.

- Starred [Uncyclopedia](/misc#random) in Fun Sites.

- Added star back to [Bloxstrap](/gaming-tools#roblox-tools).
